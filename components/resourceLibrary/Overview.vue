    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="text_box_one">
            <p v-html="value.overView.text_box_one"></p>
          </div>
        </div>
        <div class="col-lg-12 mt-5">
          <div class="text_box_two">
            <p v-html="value.overView.text_box_two"></p>
          </div>
        </div>
        <div class="col-lg-12 mt-5">
          <div class="text_box_one">
            <p v-html="value.overView.text_box_three"></p>
          </div>
        </div>
        <div class="col-lg-12 mt-5">
          <div class="text_box_two">
            <p v-html="value.overView.text_box_four"></p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-6 mt-5">
          <div class="text_box_one">
            <p v-html="value.overView.text_box_six"></p>
          </div>
        </div>
        <div class="col-lg-6 mt-5">
          <div class="text_box_two">
            <p v-html="value.overView.text_box_seven"></p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12 mt-5 m-auto">
          <div
            class="bg-white rounded shadow p-4 socialSection text-center"
            v-html="value.overView.text_box_eight"
          ></div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12 mt-5">
          <div class="text_box_one">
            <p v-html="value.overView.text_box_nine"></p>
          </div>
        </div>
        <div class="col-lg-12 mt-5">
          <div class="text_box_one">
            <p v-html="value.overView.text_box_ten"></p>
          </div>
        </div>
      </div>
      <!-- <div class="col-lg-6 mt-5 m-auto">
        <div class="text_box_five">
          <h2>IEERD Forms</h2>
          <ul v-for="(item, i) in value.research_funding_files" :key="i">
            <li>
              <a
